...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) throws SQLException {
		...
		select_date.setBounds(10, 11, 131, 29);
		...
		select_time.setBounds(151, 11, 77, 27);
		...
		btn_addWhour.setFont(new Font("Tahoma", Font.BOLD, 15));
		btn_addWhour.setBounds(238, 11, 77, 29);
		w_whour.add(btn_addWhour);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(10, 51, 689, 280);
		...
		btn_deleteWhour.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(selRow >= 0 ) {
					...
					Helper.showMsg("Lütfen bir tarhi seçiniz!");
				}
			}
		});
		btn_deleteWhour.setFont(new Font("Tahoma", Font.BOLD, 15));
		btn_deleteWhour.setBounds(325, 11, 77, 29);
