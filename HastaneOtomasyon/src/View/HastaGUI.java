...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 27, 266, 304);
		...
		lblDoktorListesi.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblDoktorListesi.setBounds(10, 0, 105, 27);
		...
		lblPoliklinikAd.setBounds(286, 11, 99, 27);
		w_appointment.add(lblPoliklinikAd);

		JComboBox select_clinic = new JComboBox();
		select_clinic.setFont(new Font("Tahoma", Font.BOLD, 15));
		select_clinic.setBounds(286, 40, 137, 35);
		...
		lblPoliklinikAd_1.setBounds(286, 86, 99, 27);
		...
		btn_selDoctor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (row >= 0) {
					...
					Helper.showMsg("Lütfen yeni bir doktor seçiniz");
				}
			}
		});
		btn_selDoctor.setFont(new Font("Tahoma", Font.BOLD, 15));
		btn_selDoctor.setBounds(286, 115, 137, 29);
		w_appointment.add(btn_selDoctor);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(433, 27, 266, 304);
		...
		lblDoktorListesi_1.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblDoktorListesi_1.setBounds(433, 0, 105, 27);
		...
		btn_addAppoint.setBounds(286, 184, 137, 29);
		w_appointment.add(btn_addAppoint);

		JLabel lblPoliklinikAd_1_1 = new JLabel("Randevu");
		lblPoliklinikAd_1_1.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblPoliklinikAd_1_1.setBounds(286, 155, 99, 27);
		...
		w_scrollAppoint.setBounds(10, 11, 689, 320);
